...
<head>
  ...
  <title>Pagamento Aprovado - Flex Major</title>
  <style>
...
<body>
  <div class="card">
    ...
    <p>Parabéns! Seu pagamento foi aprovado com sucesso.<br>
      Em breve entraremos em contato com você para os próximos passos.</p>

    <a href="https://site.flexmajorschool.com/cobranca/cobrancasExt.php" class="btn">Voltar para o início</a>
  </div>
